...
const SurveyPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    // Perform validation for compare questions
    if (compare) {
      if (!responses.preferredCustomization) {
        validationErrors.preferredCustomization = "Please select a preferred customization.";
      }
      if (!responses.reasonForPreference.trim()) {
        validationErrors.reasonForPreference = "Please provide a reason for your preference.";
      }
    }

    // If there are validation errors, set them and do not proceed
        ...
        {compare && (
          <>
            <Box mt={4} role="group" aria-labelledby="compare-question-label">
              ...
              {errors.preferredCustomization && (
                <Typography color="error" tabIndex={0}>{errors.preferredCustomization}</Typography>
              )}
            </Box>
            ...
            <Box mt={4} role="group" aria-labelledby="reason-question-label">
              ...
              <TextField
                ...
                tabIndex={0}
              />
              {errors.reasonForPreference && (
                <Typography color="error" tabIndex={0}>{errors.reasonForPreference}</Typography>
              )}
            </Box>
          </>
        )}
